...
function renderRoleVariant(){
  ...
  const title=document.getElementById('roleTitle'),info=document.getElementById('roleInfo'),hide=document.getElementById('hideRoleBtn'),card=document.getElementById('roleCard');
  ...
  hide.textContent=state.roleVisible?'Ẩn thông tin':'Hiện thông tin';
  card.classList.toggle('role-hidden',!state.roleVisible);
}
// Replace the old renderer after app.js has defined it.
renderRole=renderRoleVariant;
})();